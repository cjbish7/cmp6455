...
path = "C:\\Users\\corey\\Documents\\CMP 6455\\Assignments\\Assignment 5\\Data" # Path for Windows
...
#
# Create a K object 
# Hint: Use Kest() function with an argument [correction = "Ripley"]
K_ped = ped.ppp.mi %>% Kest(correction = "Ripley")
K_bike = bike.ppp.mi %>% Kest(correction = "Ripley")

# Plot the K function
plot(K_ped, main="Ripley's K function Ped")
plot(K_bike, main="Bike")
...
d1 = ped.ppp.mi %>% density(sigma = b2)
d2 = bike.ppp.mi %>% density(sigma = c1)
...
k1 = ped.ppp.mi %>% Kest(correction = "Ripley")
k2 = bike.ppp.mi %>% Kest(correction = "Ripley")
...
d1 %>% plot(main="Clustering of Ped. Crashes, 2018")
e1 %>% plot(main="Degree of Clustering, Ped. Crashes")
d2 %>% plot(main="Clustering of Bike Crashes, 2018")
e2 %>% plot(main="Degree of Clustering, Bike Crashes")
