...
# For Windows
path = "C:\\Users\\cjbis\\Documents\\CMP6455\\Assignment_3\\Data"
...
# C:\\Users\\cjbis\Documents\\CMP6455\\Assignment_3\\Data\\Utah_County_Boundaries
...
slco_acs = read.csv(file.path(path, "ACSDT5Y2018.B01001_2023-03-04T221301", "ACSDT5Y2018.B01001-Data.csv" ))
...
slco_tracts_join = 
  st_join( slco_tracts, slco_crashes_cleaned, left = FALSE ) %>%
...
slco_tracts_acs_join = 
  left_join(slco_tracts_join,slco_acs_pop) %>%
  mutate(
...
tm_shape( slco_tracts_acs_join ) + tm_polygons( "ped_crash_rate_1k", palette="Reds", style="jenks" ) +
  tm_shape( slco_ped_crashes ) + tm_dots(alpha = 0.3) +
  tm_layout(
